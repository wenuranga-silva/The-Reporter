    ...
    <div class="col-12">
        ...
        <div class="card shadow">
            ...
            <div class="card-header d-flex">
                ...
                <h6 class="m-0 font-weight-bold text-primary align-content-center">All Videos (<code>Created By
                        {!! Auth::user()->name !!}</code>)</h6>

                <a href="{{ route('admin.video.create') }}" class="btn btn-sm btn-primary shadow-sm"
